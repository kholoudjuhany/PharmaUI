    ...
    <div class="container">
        ...
        @if(isset($prescription))  <!-- Check if prescription exists -->
            ...
            @elseif($prescription->status === 'cancelled')
                <p class="mb-4">Your prescription is cancelled. Please resubmit your prescription below.</p>
                <!-- Show form if the prescription is cancelled -->
                <div class="row">
                    <div class="col-md-12">
            ...
            @else
                <p class="mb-4">Your prescription is {{ $prescription->status }}.</p>
            @endif
        @else
            <!-- Show form if no prescription exists -->
            <div class="row">
                <div class="col-md-12">
                    <h3 class="mb-4">Please add your prescription</h3>
                    <form action="{{ route('prescriptions.store') }}" method="POST" enctype="multipart/form-data">
